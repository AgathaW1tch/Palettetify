...
# @app.route('/search_result.html', methods=['GET'])
...
def liked_post():
    ...
    return render_template("liked_posts.html", post_ids = post_ids,rgb_1_arraycopy=rgb_1_arraycopy,  rgb_1_array = rgb_1_array, rgb_2_array = rgb_2_array, rgb_3_array = rgb_3_array, average_rgb_array = average_rgb_array)
